...
- **KI antwortet im Teams-Chat.** Eingehende Nachrichten an das Bot-Konto beantwortet eine
  ...
  (Spalte `diagnose`, Migration); die Probefrage läuft mit dem eigenen Konto. Das Gedächtnis (frühere
  Nachrichten je Chat, Standard 12) ist in der Maske einstellbar.
...
- **Anmeldung mit dem Microsoft-Konto (Entra ID / Microsoft 365).** Auf der Anmeldeseite gibt es
  ...
  **Das lokale Passwort entfällt:** Ist ein Konto einmal über Microsoft hereingekommen, wird die
  Anmeldung mit Passwort abgelehnt (ebenso „Passwort vergessen"), und im Profil steht der Hinweis
